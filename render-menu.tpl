...
{elseif 'account' == $position}
    {if 'account' == $menu.name && $member && $core.config.members_enabled}
        <ul class="inv__nav">
            <li class="hidden-xs"><a href="{$core.packages.autos.url}comparison/"><span class="fa fa-balance-scale"></span> {lang key='page_title_autos_comparison'}</a></li>
            ...
            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                    {ia_image file=$member.avatar type='thumbnail' title=$member.fullname|default:$member.username class='img-circle' gravatar=true email=$member.email width=20}
    ...
    {else}
        <ul class="inv__nav">
            <li><a href="{$core.packages.autos.url}comparison/"><span class="fa fa-balance-scale"></span> {lang key='page_title_autos_comparison'}</a></li>
            <li class="hidden-xs"><a href="{$smarty.const.IA_URL}favorites/"><span class="fa fa-star text-warning"></span> {lang key='wishlist'}</a></li>
